        ...
        while (opcao != 4) {
            ...
            switch (opcao) {
                ...
                case 3:
                    ...
                    double totalTomate = quantidadeTomate * precoTomate;
                    double totalBatata = quantidadeBatata * precoBatata;
                    double totalCebola = quantidadeCebola * precoCebola;
                    double totalEstoque = totalTomate + totalBatata + totalCebola;

                    System.out.println("Produto: " + nomeTomate);
                    System.out.println("Quantidade em estoque: " + quantidadeTomate);
                    System.out.printf("Valor unitário: R$%.2f\n", precoTomate);
                    System.out.printf("Valor total em estoque: R$%.2f\n", totalTomate);
                    System.out.println("-----------------------------------");

                    System.out.println("Produto: " + nomeBatata);
                    System.out.println("Quantidade em estoque: " + quantidadeBatata);
                    System.out.printf("Valor unitário: R$%.2f\n", precoBatata);
                    System.out.printf("Valor total em estoque: R$%.2f\n", totalBatata);
                    System.out.println("-----------------------------------");

                    System.out.println("Produto: " + nomeCebola);
                    System.out.println("Quantidade em estoque: " + quantidadeCebola);
                    System.out.printf("Valor unitário: R$%.2f\n", precoCebola);
                    System.out.printf("Valor total em estoque: R$%.2f\n", totalCebola);
                    System.out.println("-----------------------------------");
